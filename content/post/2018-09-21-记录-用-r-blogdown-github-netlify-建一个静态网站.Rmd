---
title: 记录：用 R(blogdown)+github+netlify 建一个静态网站
author: wanshq
date: '2018-09-21'
...
iii.如果以上两种报错，把错误信息中的链接复制到浏览器直接下载，把文件解压得到[一个hugo文件](https://yihui.name/en/2017/12/blogdown-book/)，把解压好的 hugo.exe文件放在d:/根目录下，然后输入下面代码安装 hugo：
...
参考文献：
[blogdown: Create Blogs and Websites with R Markdown](https://bookdown.org/yihui/blogdown/)
...
[用 blogdown 搭建一个静态网站](https://slides.yihui.name/2017-blogdown-CGM-Yihui-Xie.html#1)
[GIT 子模块](https://yihui.name/cn/2017/03/git-submodule/)
